...
public class FXMLController {
	...
	void doAnalizzaAeroporti(ActionEvent event) {
		...
		try {
			...
			txtResult.appendText("Inserisci valore numerico");
			return;
		}
	...
	void doTestConnessione(ActionEvent event) {
		List<Airport> percorso = this.model.getPercorso(cmbBoxAeroportoPartenza.getValue(),
	...
	void initialize() {
		...
		assert compagnieMinimo != null
				: "fx:id=\"compagnieMinimo\" was not injected: check your FXML file 'Scene.fxml'.";
		assert cmbBoxAeroportoPartenza != null
				: "fx:id=\"cmbBoxAeroportoPartenza\" was not injected: check your FXML file 'Scene.fxml'.";
		assert cmbBoxAeroportoDestinazione != null
				: "fx:id=\"cmbBoxAeroportoDestinazione\" was not injected: check your FXML file 'Scene.fxml'.";
